...
const stagesData = [
  {
    id: 3,
    type: 'stage',
    title: 'Stage Perfectionnement - Tous les postes',
    date: '2025-10-27',
    dateFormatted: 'Du 27/10/2025 au 31/10/2025 inclus',
    time: '09h00 à 16h30',
    city: 'Montpellier',
    venue: 'Terrain synthétique',
    venueAddress: '780 Rue Paul Rimbaud\n34080 Montpellier',
    googleMapsLink: 'https://maps.google.com/?q=780+Rue+Paul+Rimbaud+34080+Montpellier',
    category: 'u10-u13',
    categoryLabel: 'U10 à U13',
    ageRange: 'de 10 à 13 ans',
    placesTotal: 20,
    placesLeft: 12,
    price: '160€',
    ...
    positionLabel: 'Tous les postes',
    description: 'Stage de perfectionnement pour tous les postes. Développe tes compétences techniques et tactiques avec des entraîneurs professionnels.',
