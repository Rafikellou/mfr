...
export default function ClasicoCup() {
  return (
    <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-4xl md:text-5xl font-bold text-primary mb-2">Clasico Cup</h2>
        <p className="text-2xl md:text-3xl text-gray-700 mb-8">Hérault vs. Gard</p>
        ...
        <div className="max-w-4xl mx-auto mb-10 relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center z-20 text-white px-4">
            <p className="text-xl md:text-2xl font-bold mb-4 text-center">18 Avril 2026 à Bellegarde</p>
            <Link 
              href="/clasico-cup" 
