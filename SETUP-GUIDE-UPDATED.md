# 🚀 Configuration CMS MFR - Guide Mis à Jour
...
- ✅ **Page d'inscription créée** avec restriction d'emails
...
ADMIN_EMAIL=mfracing34@gmail.com
```
...
- **Inscription** : `http://localhost:3000/admin/signup`
...
2. **Push vers GitHub** :
   ```bash
   git add .
   git commit -m "Add signup page with email restrictions"
...
- **Page d'inscription** : `https://mf-racing.fr/admin/signup`

## 🔑 **Emails autorisés pour l'inscription**
...
- ✅ **Page d'inscription** avec restriction d'emails
...
1. Allez sur `https://mf-racing.fr/admin/signup`
2. Utilisez un des emails autorisés
3. Créez un mot de passe
4. Vous êtes automatiquement connecté au CMS !

**Temps total : 10-15 minutes**

Votre CMS avec inscription restreinte est prêt ! 🎉
